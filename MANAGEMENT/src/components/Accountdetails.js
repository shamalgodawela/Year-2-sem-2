...
<button type="button" className="btn btn-success"><a href="/cr" style={{textDecoration:'none',color:'white'}}>Add details</a></button>
&nbsp;&nbsp;
&nbsp;&nbsp;

<button type="button" className="btn btn-success"><a href="/accreport" style={{textDecoration:'none',color:'white'}}>Report</a></button>
